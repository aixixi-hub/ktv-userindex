...
export const constantRoutes = [
...

  {
    ...
    children: [{
      ...
      meta: { title: '用户首页', icon: 'dashboard' }
    }]
  },

  {
    ...
    name: 'Example',
    meta: { title: '查看个人收藏', icon: 'example' },
    children: [
      {
        path: 'collectiom',
        name: 'Collectiom',
        component: () => import('@/pages/songset/CollectManage'),
        meta: { title: '收藏信息', icon: 'table'}
      }     
    ]
  },
  {
  ...
  },
  {
    ...
    redirect: '/example/table',
    name: 'Example',
    meta: { title: '查看歌手', icon: 'example' },
    children: [
      {
        path: 'singer',
        name: 'Singer',
        component: () => import('@/pages/singerset/SingerManage'),
        meta: { title: '歌手信息', icon: 'table' }
      }, 
    ]
  },
  {
    ...
    redirect: '/example/table',
    name: 'Example',
    meta: { title: '查看专辑', icon: 'example' },
    children: [
      {
        path: 'album',
        name: 'Album',
        component: () => import('@/pages/albumset/AlbumManage'),
        meta: { title: '专辑信息', icon: 'table' }
      },    
    ]
  },
